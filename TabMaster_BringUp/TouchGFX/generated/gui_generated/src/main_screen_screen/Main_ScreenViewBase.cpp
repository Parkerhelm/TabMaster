...
void Main_ScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //Start_Counting
        //When Start_Button clicked change screen to Counting_Screen
        //Go to Counting_Screen with no screen transition
        application().gotoCounting_ScreenScreenNoTransition();
    }
    if (&src == &Reset_Button)
    {
        //Reset_Count
        //When Reset_Button clicked change screen to Startup_Screen
        //Go to Startup_Screen with no screen transition
        application().gotoStartup_ScreenScreenNoTransition();
    }
}
